...
description: Three.js scene setup, cameras, renderer configuration, Object3D hierarchies, and transforms. Use when Codex is building or repairing a Three.js scene, camera setup, render loop, resize handling, or scene graph logic.
---
