...
description: Three.js asset loading for GLTF and GLB, textures, HDR and EXR, and supporting loaders such as Draco and KTX2. Use when Codex needs to import 3D assets, configure loader pipelines, track progress, or build robust async loading flows.
---
