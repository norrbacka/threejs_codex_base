...
description: Three.js post-processing with EffectComposer, passes, bloom, depth of field, and custom screen-space effects. Use when Codex is building a render pipeline beyond the base renderer or debugging full-screen visual effects.
---
