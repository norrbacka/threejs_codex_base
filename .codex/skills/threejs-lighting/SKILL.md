...
description: Three.js lighting, shadows, environment lighting, and light helpers. Use when Codex is adding lights, tuning shadow quality, setting up image-based lighting, or diagnosing a scene that looks flat or incorrect.
---
