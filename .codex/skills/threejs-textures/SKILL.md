...
description: Three.js textures, UV mapping, environment maps, texture transforms, and optimization. Use when Codex needs to load or configure texture maps, fix UV issues, wire HDRI environments, or improve texture quality and performance.
---
