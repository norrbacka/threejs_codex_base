...
description: Three.js geometry creation, BufferGeometry work, custom attributes, merging, and instancing. Use when Codex needs to create meshes, edit vertices, generate procedural geometry, or reduce draw calls with instancing.
---
