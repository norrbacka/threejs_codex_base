...
description: Three.js animation systems including clips, mixers, skeletal rigs, morph targets, and procedural motion. Use when Codex is playing imported animations, building animation state logic, blending clips, or adding time-based motion in a Three.js scene.
---
