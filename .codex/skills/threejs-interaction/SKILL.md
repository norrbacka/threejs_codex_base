...
description: Three.js interaction patterns including raycasting, controls, pointer and touch input, and selection. Use when Codex is wiring mouse or touch behavior, camera controls, hover or click picking, dragging, or other interactive 3D UI logic.
---
